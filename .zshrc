...
plugins=(git virtualenv node zsh-autosuggestions gh)
...
alias config='/usr/bin/git --git-dir=/home/eduardo/.cfg/ --work-tree=/home/eduardo'
...
__conda_setup="$('/home/eduardo/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
