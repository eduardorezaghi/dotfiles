...
# Command to change node version based on .nvmrc
cdnvm() {
    command cd "$@" || return $?
...
export PATH=$PATH:/home/eduardo/sonarscanner-guide/sonar-scanner-4.8.0.2856-linux/bin
export PATH=$PATH:/mnt/c/Users/Eduardo/pidcat
